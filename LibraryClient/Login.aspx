<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="LibraryClient.Login" %>
        ...
        <form id="form1" runat="server">
            <div class="card ms-auto me-auto p-5" style="width: 30rem;">
                ...
                <div style="display: inline">
                    <center>Don't have an account? Register <a href="Register.aspx">here</a></center>
                </div>
            </div>
        </form>
    </div>
